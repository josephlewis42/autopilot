...
def configure_base_station():
	...
	send_command(source_ser, "SERIALCONFIG COM1 38400 N 8 1 N OFF", "Setting up COM port", "[COM2]", waittime=3000)
	send_command(source_ser, "INTERFACEMODE COM1 NONE RTCA OFF", "Setting up DGPS", "<OK")
	send_command(source_ser, "POSAVE 0.1 0.05 0.05", "Setting up DGPS Position", "<OK")
	send_command(source_ser, "LOG COM1 RTCAOBS ONTIME 2", "Setting up DGPS RTCAOBS", "<OK")
	send_command(source_ser, "LOG COM1 RTCAREF ONTIME 10", "Setting up DGPS RTCAREF", "<OK")
	send_command(source_ser, "LOG COM1 RTCA1 ONTIME 10 3", "Setting up DGPS RTCA1", "<OK")
	send_command(source_ser, "LOG COM1 RTCAEPHEM ONTIME 10 7", "Setting up DGPS RTCAEPHEM", "<OK")
...
def configure_rover():
	...
	send_command(source_ser, "FRESET", "Resetting Device Firmware", "<OK", waittime=3000)
	send_command(source_ser, "SERIALCONFIG COM1 38400 N 8 1 N OFF", "Setting up COM1", "[COM2]", waittime=3000)
	send_command(source_ser, "INTERFACEMODE COM1 RTCA NONE OFF", "Setting up COM1 DGPS", "<OK")
	send_command(source_ser, "SAVECONFIG", "Saving", waittime = 3000)
	send_command(source_ser, "COM COM2 38400 N 8 1 N OFF ON", "Setting new baud for com2", waittime=3000)
	source_ser.close()
